...
public:
	...
	// 绘制物体
    void drawMesh(glm::mat4 modelMatrix ,TriMesh* mesh, openGLObject &object, Light *light, Camera* camera, int texopen);

	// 绘制阴影
	void drawShadow(glm::mat4 modelMatrix ,TriMesh* mesh, openGLObject &object, Light *light, Camera* camera, float pos);
